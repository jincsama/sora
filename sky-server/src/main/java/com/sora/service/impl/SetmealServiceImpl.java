...
public class SetmealServiceImpl implements SetmealService {
    ...
    public void deleteBatch(List<Long> ids) {
        ...
        ids.forEach(setmealId -> {
            ...
            cacheEvict(setmealId);
        });

    }

    @CacheEvict(cacheNames = "setmealCache", key = "#setmealId")
    public void cacheEvict(List<Long> setmealId) {
    }
    ...
    public void startOrStop(Integer status, Long id) {
        ...
        cacheEvict(setmeal1.getCategoryId());
    }

    @CacheEvict(cacheNames = "setmealCache", key = "#categoryId")
    public void cacheEvict(Long categoryId) {
    }
